...
class EventApp(App):
    ...
    def __init__(self, subject, disp, buttons, tim, class):
        ...
        self.add_item("Back", Button(cont.lv_obj, text="Back",
                                          width=cont.half(), app=), selectable=True)
    ...
    def get_data(self):
        time_data = TimeData("timedata.json", self.subject, self.class++)
        return time_data.get_time_data(self.class).split(" ")
