# This is adapted from the ILI934X driver from https://github.com/tuupola/micropython-ili934x
...
class ILI9341:
    ...
    def __init__(self):
        self.spi = SPI(1, 40000000, miso=Pin(12), mosi=Pin(13), sck=Pin(14))
        self.cs = Pin(18)
        self.dc = Pin(19)
        self.rst = Pin(5)
        self.width = 160
    ...
    def write(self, text):
        # This function will wrap the next character onto the next line if necessary
        curx = self._x
        cury = self._y
    ...
    def print(self, text):
        # This function will wrap the next word onto the next line if necessary
        cury = self._y
        curx = self._x
        char_h = self._font.height()
