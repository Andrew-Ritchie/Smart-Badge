...
class GameObj():
    ...
    def __init__(self, parent, w, h, x, y, obj):
        ...
        if obj == "rock":
            self.outer_line.set_custom_style(self.outer_line.create_style(colour=(79,55,48),width=2))
        else:
            self.outer_line.set_custom_style(self.outer_line.create_style(colour=(0xff,0x14,0x44),width=1))
